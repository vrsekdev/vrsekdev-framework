...
namespace Havit.Blazor.StateManagement.Mobx.PropertyObservables.RuntimeType
{
    internal static class RuntimeTypeBuilder
    {
        ...
        private static TypeBuilder CreateTypeBuilder(Type interfaceType)
        {
            ...
            typeBuilder.AddInterfaceImplementation(typeof(IRuntimeTypeImpl));
        ...
        {
            Type managerType = typeof(IRuntimeTypePropertyObservableManager);
            string propertyName = nameof(IRuntimeTypeImpl.Manager);
